<template>
	<div class="md:shadow-xl md:p-10 md:flex md:flex-col">
		<div
			class="flex xsm:justify-between items-start sm:gap-2 sm:mb-10 mt-4 h-full flex-wrap xsm:flex-nowrap"
		>
			...
			<div class="w-28 flex gap-4 sm:items-center flex-col sm:flex-row">
				<div v-if="isEditable">
					<button
						@click="edit"
